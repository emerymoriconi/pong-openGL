...
/*
 * Desenha placar na posicao (x,y)
 */
void draw_score(float x, float y, int score1, int score2)
{
    std::string scoreText = "SCORE " + to_string(score1) + "  -  " + to_string(score2);
    draw_text_bitmap(x, y, scoreText);
}
